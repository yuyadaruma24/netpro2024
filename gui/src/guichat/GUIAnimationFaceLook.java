...
class GUIAnimatinFaceLook {// 顔のオブジェクト
	...
	private void makeSmileEyebrows(Graphics g) {
        g.drawArc(xStart + (h * 2 / 7) - 5, yStart + (w * 1 / 4) - 10, w / 5 + 10, 10, 0, 180);
        g.drawArc(xStart + (h * 4 / 7) - 5, yStart + (w * 1 / 4) - 10, w / 5 + 10, 10, 0, 180);
    }

    private void makeAngryEyebrows(Graphics g) {
        g.drawLine(xStart + (h * 2 / 7), yStart + (w * 1 / 4)-10, xStart + (h * 2 / 7) + w / 5, yStart + (w * 1 / 4));
        g.drawLine(xStart + (h * 4 / 7), yStart + (w * 1 / 4), xStart + (h * 4 / 7) + w / 5, yStart + (w * 1 / 4)-10);
    }

    private void makeNormalEyebrows(Graphics g) {
        g.drawLine(xStart + (h * 2 / 7), yStart + (w * 1 / 4), xStart + (h * 2 / 7) + w / 5, yStart + (w * 1 / 4));
        g.drawLine(xStart + (h * 4 / 7), yStart + (w * 1 / 4), xStart + (h * 4 / 7) + w / 5, yStart + (w * 1 / 4));
    }
}// FaceObj End